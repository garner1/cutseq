...
cat "$dsb"__raw_segmented_q"$quality"_res"$resolution".bed | awk -v norma="$norma" '{FS=OFS="\t"; print $1,$2,$3,$4/norma}'|head

echo $norma
rm -f "$dsb"__raw_segmented_q"$quality"_res"$resolution".bed "$dsb"__A.bed
